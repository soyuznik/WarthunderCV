...
void load_net(cv::dnn::Net& net, bool is_cuda)
{
    ...
    auto result = cv::dnn::readNetFromDarknet("Models/yolov4_train.cfg" , "Models/yolov4_train_last.weights");
    if (is_cuda)
    {
...
int main(int argc, char** argv)
{
    ...
    cv::Mat image = cv::imread("dat3/file23169999372.bmp"); // Provide the path to your input image
    if (image.empty())
    {
